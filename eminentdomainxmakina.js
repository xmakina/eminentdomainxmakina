		...
		return declare("bgagame.eminentdomainxmakina", bgagame.sharedparent, // parent declared in shared module
			{
				constructor: function() {
					console.log('eminentdomainxmakina constructor');
				 ...
				 * 
				 * Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in your eminentdomainxmakina.game.php file.
				 * 
				 */
