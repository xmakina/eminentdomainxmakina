 ...
 * -----
 * 
 * eminentdomainxmakina.action.php
 *
 ...
 * this.ajaxcall( "/eminentdomainxmakina/eminentdomainxmakina/myAction.html", ...)
 *
 */
class action_eminentdomainxmakina extends APP_GameAction {
    ...
    public function __default() {
        if (self::isArg('notifwindow')) {
            ...
            $this->view = "eminentdomainxmakina_eminentdomainxmakina";
